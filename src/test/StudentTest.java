...
public class StudentTest {
    public static void main(String[] args) throws IOException {
        ...
        FirestoreConstants.studentCollectionReference.listDocuments().forEach(documentReference -> {
            try {
                DocumentSnapshot documentSnapshot = documentReference.get().get();

                FirestoreConstants.studentCollectionReference.document(documentSnapshot.getId()).update("id", documentSnapshot.getId());
